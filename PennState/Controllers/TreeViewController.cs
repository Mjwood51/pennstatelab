...
namespace PennState.Controllers
{
    public static class TreeViewHelper
    {
        ...
        /// </summary>
        public static TreeViewController<T> TreeViewController<T>(this HtmlHelper html, IEnumerable<T> items)
        {
            return new TreeViewController<T>(html, items);
        }
    }

    public class TreeViewController<T> : Controller, IHtmlString
    {
        ...
        public TreeViewController(HtmlHelper html, IEnumerable<T> items)
        {
        ...
        /// </summary>
        public TreeViewController<T> ItemText(Func<T, string> selector)
        {
        ...
        /// </summary>
        public TreeViewController<T> ItemTemplate(Func<T, HelperResult> itemTemplate)
        {
        ...
        /// </summary>
        public TreeViewController<T> Children(Func<T, IEnumerable<T>> selector)
        {
            //  if (selector == null) //throw new ArgumentNullException("selector");
        ...
        /// </summary>
        public TreeViewController<T> EmptyContent(string emptyContent)
        {
        ...
        /// </summary>
        public TreeViewController<T> HtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the root ul node
        /// </summary>
        public TreeViewController<T> HtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        /// </summary>
        public TreeViewController<T> ChildrenHtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the children items
        /// </summary>
        public TreeViewController<T> ChildrenHtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
            if (htmlAttributes == null) throw new ArgumentNullException("htmlAttributes");
        ...
        {
            return Content(nodeId.ToString());
        }
    }
}